...
import { ArrowLeft, MapPin, Calendar, Ruler, Weight, TrendingUp, TrendingDown, Star, Target, AlertTriangle } from 'lucide-react';
      ...
      {/* Header */}
        <div className="bg-white border-b">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className={`px-4 py-2 rounded-full text-sm font-semibold ${getGradeColor(player.overallRating)}`}>
        ...
        <div className="flex justify-center py-8 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-5xl space-y-8">
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">Physical Attributes</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-2xl font-bold text-gray-900">{player.class}</div>
