...
export default async function PlayerPage({ params }: PlayerPageProps) {
    ...
    // Fetch player info
    const res = await fetch(`http://localhost:8000/nba/players/${id}`, {
        cache: "no-store",
    });
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex justify-center py-8 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-5xl space-y-8">
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                ...
                                <div className="text-2xl font-bold text-gray-900">{player.height}</div>
                                <div className="text-sm text-gray-600">Height</div>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <Weight className="w-6 h-6 text-orange-600 mx-auto mb-2" />
                                <div className="text-2xl font-bold text-gray-900">{player.weight}</div>
                                <div className="text-sm text-gray-600">Weight</div>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <Target className="w-6 h-6 text-orange-600 mx-auto mb-2" />
                                <div className="text-2xl font-bold text-gray-900">{player.position}</div>
                                <div className="text-sm text-gray-600">Position</div>
                            </div>
                            <div className="text-center p-4 bg-gray-50 rounded-lg">
                                <Calendar className="w-6 h-6 text-orange-600 mx-auto mb-2" />
                                <div className="text-2xl font-bold text-gray-900">{player.years_pro}</div>
                    ...
                    {player.stats && (
                        <div className="bg-white rounded-lg shadow-sm p-6">
                            <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">Stats</h2>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                                ...
                                {player.stats.fieldGoalPercentage && (
                                    <div>
                                        <div className="text-2xl font-bold">{player.stats.fieldGoalPercentage}%</div>
                                        <div className="text-gray-600">FG%</div>
                                    </div>
                                )}
                                {player.stats.threePointPercentage && (
                                    <div>
                                        <div className="text-2xl font-bold">{player.stats.threePointPercentage}%</div>
                                ...
                                {player.stats.winShares && (
                                    <div>
                                        <div className="text-2xl font-bold">{player.stats.winShares}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6">
                            <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center justify-center">
                                <TrendingDown className="w-5 h-5 text-red-600 mr-2" /> Weaknesses
                            </h3>
                            <ul className="space-y-2">
