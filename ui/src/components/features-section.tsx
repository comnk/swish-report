...
import { GraduationCap, Trophy, Star, TrendingUp, Users, BarChart3 } from "lucide-react";
...
export default function FeaturesSection() {
    const features = [
        ...
        description: "Real-time NBA draft rankings with AI-powered projections and team fit analysis for upcoming prospects.",
        href: "/draft",
        color: "bg-orange-500",
        },
        {
        ...
        description: "Cutting-edge analytics including efficiency ratings, impact metrics, and predictive modeling.",
        href: "/analytics",
        color: "bg-indigo-500",
        },
    ];
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                From high school gyms to NBA arenas, our AI-powered platform provides 
                comprehensive scouting and analysis across all levels of basketball.
            </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">Ready to revolutionize your scouting?</h3>
                <p className="text-orange-100 mb-6 max-w-2xl mx-auto">
                Join thousands of coaches, scouts, and analysts who trust Swish Report 
                for their basketball intelligence needs.
                </p>
