      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Get comprehensive AI-powered scouting reports and analysis for high
            school, college, and NBA players. Make smarter decisions with
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl shadow-2xl p-8 border border-slate-700">
              ...
              <div className="text-slate-300 text-sm leading-relaxed">
                <strong className="text-orange-400">AI Analysis:</strong> Elite
                court vision and basketball IQ. Exceptional three-point shooter
                with NBA-ready range. Projects as a lottery pick with potential
                for immediate impact at the next level...
              </div>
            </div>
          </div>
        </div>
