      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Our AI-powered platform delivers insights that help teams make
            better decisions, from recruitment to roster management.
          </p>
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-slate-800 rounded-2xl p-8 max-w-4xl mx-auto border border-slate-700">
            <div className="text-2xl text-slate-300 mb-6 italic">
              &ldquo;Swish Report has completely transformed how we evaluate
              talent. The AI insights have helped us identify hidden gems and
              make more informed recruiting decisions.&rdquo;
            </div>
